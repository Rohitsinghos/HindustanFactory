              ...
              SizedBox(
                ...
                child: Center(
                  child: Padding(
                    ...
                    child: Text(
                      msg ?? "You need to be a premium user!",
                      style: TextStyle(
                        fontSize: 15,
  ...
  Future<void> _getbookedproduct() async {
    ...
    try {
      ...
      if (req.statusCode == 201) {
        ...
        msg = "Product is already Booked.";
        dialogEnquire(msg);
      } else {
        msg = "Product booking Failed. Try again.";
        dialogEnquire(msg);
      }
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: ListView.builder(
                      ...
                      itemCount:
                          (buyItemData != -1 && buyItemData['gallery'] != null)
                                  ...
                                  ? Container(
                                    child: Padding(
                                      ...
                                      child: Text(
                                        (buyItemData == null)
                                            ? ""
                                            : "Cash on delivery is ${(buyItemData["cod_enabled"] ?? true) ? "Available" : "Unavailable"}.\n" +
                                                "Shipping charges is ${(buyItemData["shipping_value_type"] != null || buyItemData["shipping_value_type"] == "FREE_SHIPPING") ? "FREE" : "APPLICABLE"}.\n" +
                                                "Return days will be ${buyItemData["return_days"] ?? 0} days.",
                                      ),
                                    ),
                                  )
                                  : Container(),
                          ...
                          return productCard2(
                            ...
                            rating:
                                (itemsTop[index]['rating'] != null)
                                    ...
                                    : 0,
                            left: itemsTop[index]["variants"][0]["quantity"],
